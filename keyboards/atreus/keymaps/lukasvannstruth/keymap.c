...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUMNAV] = LAYOUT( /* [> RAISE <] */
    ...
    KC_TRNS,   KC_0,   KC_LGUI, KC_LSFT, KC_BSPC, KC_LALT, KC_LCTL, KC_SPC,  KC_TRNS, KC_VOLD, KC_MSEL, KC_VOLU
    ),
  /*  
   ...
   */
  [_MISC] = LAYOUT( /* [> LOWER <] */
    KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP,                   KC_UP,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
    KC_DELT, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,                   KC_DOWN, KC_F5,   KC_F6,   KC_F7,   KC_F8,
    KC_NO,   KC_VOLU, KC_NO,   KC_NO,   RESET,                     KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F4,
    KC_TRNS, KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC, KC_LALT, KC_LCTL, KC_SPC,  TO(_TYPING), KC_PSCR, KC_SLCK, KC_PAUS )
};
